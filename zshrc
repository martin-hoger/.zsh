...
alias d='dirs -v'
alias df='df -h | grep -vP "docker|tmpfs|udev|/dev/loop"'
...
alias opera-pipe='tee ~/tmp/output.html; opera ~/tmp/output.html'
alias opera-pipe-reload='tee ~/tmp/output.html;'
...
alias pk='~/fetview-repos/cluster-kuberspray/bin/profitbricks-server-kube.sh'
